...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		data = bundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] dataConverted = data.toArray(new Integer[data.size()]);

		// TODO: Start the DownloaderTask 
		downloaderTask.execute(dataConverted);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Integer, String[]> {
		...
		protected String[] doInBackground(Integer[]... params) {
			...
			mResult = downloadTweets(resourceIDS);
			return mResult;
		}
